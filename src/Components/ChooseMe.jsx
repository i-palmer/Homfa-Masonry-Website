...
export default function ChooseMe() {
    return (
        <div className="px-[45px]">
            <h1 className="text-[32px] font-semibold mt-[40px] mb-[40px]">Why Choose Me</h1>
            <div className=".border">
            <div className="flex flex-col md:flex-row">
                <div className="mb-[30px]">
                    <h4 className="text-[25px] font-semibold mb-[10px]">Premium Quality</h4>
                    <p className="text-[15px] text-[#232323] font-medium mb-[7.5px] ml-[5px]">
                    ...
                    <hr className="w-[250px] bg-[#BBBBBB] h-[2px] ml-[12px]"></hr>
                </div>
                <div className="mb-[30px]">
