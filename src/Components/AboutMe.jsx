        ...
        <div className="text-[#F8F8F8] pl-[20px] pb-[50px]">
            <div className="flex flex-col lg:flex-row">
                <div className="mr-[20px]">
                    <h1 className="text-[35px] text-white mb-[35px] leading-9">
                        I am Larry Hofma and have been a mason since 1980.
                    </h1>
                    <img className=" rounded-t-[20px]"
                    src="/IMG_20151023_164855637.jpg"/>
                    <h1 className="mt-[50px] text-[30px] text-[#DEDEDE]">About Me</h1>
                    <p className="mt-[15px] text-[15px] text-[#999999]">
